...
angular.module('store')
    ...
    var urlBase = 'http://2.genuine-amulet-864.appspot.com/getlistings/user/';
    var dataFactory = {};
    ...
    dataFactory.getUserItems = function (id) {
        return $http.get(urlBase + '/' + id + '/1');
    };
...
angular.module('store')
    .controller('StoreController', ['$scope', 'dataFactory', 
    ...
    $scope.getCustomerItems = function (id) {
        dataFactory.getUserItems(id)
...
// 	app.controller('StoreController', function($scope, $http, $resource) {
...
//         // 10206061236233936 - for a different user
//         // $scope.url1 = 'http://2.genuine-amulet-864.appspot.com/getlistings/user/10200204025/1';

//         var someId = $resource('http://2.genuine-amulet-864.appspot.com/getlistings/user/:userID/1',{userID: '@userID'} );


//         someId.get( {userID:10206061236233936}, function(user){
//                 $scope.posts = user;
//                 // $scope.posts = data; 
