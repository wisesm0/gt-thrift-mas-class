(function() {   
	...
	app.controller('StoreController', function($scope, $http) {
        ...
        // http://plnkr.co/edit/E0X1ZIo0Gr7hsulrwqnK?p=preview
        // http://stackoverflow.com/questions/24837035/changing-variable-value-dynamically-with-angularjs


        $scope.url1 = 'http://2.genuine-amulet-864.appspot.com/getlistings/1'; 
        ...
        $scope.acases = [
           ...
           {id:8, value:"Others", url:"http://2.genuine-amulet-864.appspot.com/getlistings/others/1"},
           {id:9, value:"Cars", url:"http://2.genuine-amulet-864.appspot.com/getlistings/cars/1"},
           {id:10, value:"Sports", url:"http://2.genuine-amulet-864.appspot.com/getlistings/sports/1"},
           {id:11, value:"Tickets", url:"http://2.genuine-amulet-864.appspot.com/getlistings/tickets/1"},
           {id:12, value:"Clothing", url:"http://2.genuine-amulet-864.appspot.com/getlistings/clothing/1"},
           {id:13, value:"Electronics", url:"http://2.genuine-amulet-864.appspot.com/getlistings/electronics/1"},
           {id:14, value:"Housing", url:"http://2.genuine-amulet-864.appspot.com/getlistings/housing/1"},
           {id:15, value:"All Listings", url:"http://2.genuine-amulet-864.appspot.com/getlistings/1"},
           {id:16, value:"My Listings", url:"http://2.genuine-amulet-864.appspot.com/getlistings/user/10200204025/1"}
        ];
        ...
        */
        ...
        // $http.jsonp(url1 + "&callback=JSON_CALLBACK").success(function(data) {

        // $http.jsonp()
        $http({method: 'GET', url: $scope.url1}).success(function(data) {
                $scope.posts = data; 
