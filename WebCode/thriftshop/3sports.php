...
<script type="text/javascript" src="js/3sports.js"></script> 
<script>
...
<!-- 		//ng-href="{{acas.url}}"-->			
				...
				<li><a href="3sports.php" class="active">Sports</a></li>
	...
	<div class="content slide">     
		...
		<ul class="responsive">
			<li class="header-section">
				...
				<p class="placefiller">Viewing: {{acases[2].value}}</p>
			</li>
...
<!-- 							<button class="btn btn-primary" type="button" ng-click="doesItemMatch(product)" style="float:right">fuck it</button>
 -->
							<form action="3sportItem.php" method = 'post'>
