...
<script type="text/javascript" src="js/4tickets.js"></script> 
<script>
...
<!-- 		//ng-href="{{acas.url}}"-->			
				...
				<li><a href="4tickets.php" class="active">Tickets</a></li>
	...
	<div class="content slide">     
		...
		<ul class="responsive">
			<li class="header-section">
				...
				<p class="placefiller">Viewing: {{acases[3].value}}</p>
			</li>
...
<!-- 							<button class="btn btn-primary" type="button" ng-click="doesItemMatch(product)" style="float:right">fuck it</button>
 -->
							<form action="4ticketItem.php" method = 'post'>
