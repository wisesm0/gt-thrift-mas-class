...
<script type="text/javascript" src="js/6electronics.js"></script> 
<script>
...
<!-- 		//ng-href="{{acas.url}}"-->			
				...
				<li><a href="6electronics.php" class="active">Electronics</a></li>
	...
	<div class="content slide">     
		...
		<ul class="responsive">
			<li class="header-section">
				...
				<p class="placefiller">Viewing: {{acases[5].value}}</p>
			</li>
...
<!-- 							<button class="btn btn-primary" type="button" ng-click="doesItemMatch(product)" style="float:right">fuck it</button>
 -->
							<form action="6electronicsItem.php" method = 'post'>
