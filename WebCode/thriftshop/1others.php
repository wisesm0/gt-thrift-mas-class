...
<script type="text/javascript" src="js/1others.js"></script> 
<script>
...
<div ng-controller="StoreController as store"> 
	<nav class="slide" >
	 ...
	 <!-- change the way this image is diplayed; comoe up with a way to move it from 
		...
		<ul>
<!-- 		//ng-href="{{acas.url}}"-->			
<!-- 			<li ng-repeat="acas in acases" ng-class="{'active':acas.url == url}"><a ng-href="{{theurl}}" ng-click="changeURL(acas)">{{acas.value}}</a></li>
 -->			<li><a href="7housing.php">Housing</a></li>
				...
				<li><a href="1others.php" class="active" >Other</a></li>
	...
	<div class="content slide">     
		...
		<ul class="responsive">
			<li class="header-section">
				...
				<p class="placefiller">Viewing: {{acases[0].value}}</p>
			</li>
...
<!-- 							<button class="btn btn-primary" type="button" ng-click="doesItemMatch(product)" style="float:right">fuck it</button>
 -->
							<form action="1otherItem.php" method = 'post'>
