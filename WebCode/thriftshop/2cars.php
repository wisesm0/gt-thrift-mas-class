...
<script type="text/javascript" src="js/2cars.js"></script> 
<script>
...
<div ng-controller="StoreController as store"> 
	<nav class="slide" >
	 ...
	 <!-- change the way this image is diplayed; comoe up with a way to move it from 
		...
		<ul>
<!-- 		//ng-href="{{acas.url}}"-->			
<!-- 			<li ng-repeat="acas in acases"><a ng-href="{{theurl}}" ng-click="changeURL(acas)">{{acas.value}}</a></button></li>
 -->			
				...
				<li><a href="2cars.php" class="active">Vehicles</a></li>
	...
	<div class="content slide">     
		...
		<ul class="responsive">
			<li class="header-section">
				...
				<p class="placefiller">Viewing: {{acases[1].value}}</p>
			</li>
...
<!-- 							<button class="btn btn-primary" type="button" ng-click="doesItemMatch(product)" style="float:right">fuck it</button>
 -->
							<form action="2carItem.php" method = 'post'>
